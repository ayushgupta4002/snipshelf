...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[hsl(0,0%,13%)] to-black">
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-25">
          <div className="text-left sm:mt-8">
            <h1 className="text-6xl font-bold flex flex-row items-end space-x-4 font-font1 tracking-tight opacity-0 animate-slidein300 text-primary mb-6">
              <span> Give your code a shelf </span>{" "}
            ...
            <p className="text-xl  font-font1 text-muted-foreground max-w-2xl opacity-0 animate-slidein500 mb-12">
              Store, organize, and access your code snippets with ease. Never
              lose track of your valuable code fragments again.
            </p>
            <Link href="/dashboard">
              <Button
                size="lg"
                className=" opacity-0 animate-slidein700 bg-gradient-to-r from-white to-cyan-600"
              >
      ...
      <Card className="w-full max-w-full rounded-none bg-white/5 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-black-500/10 via-transparent to-black-500/10" />
      ...
      <div className="w-full flex my-2 justify-center items-center">
        <Button
          variant={"outline"}
          className="mt-5 items-center bg-gradient-to-r from-cyan to-black-200 rounded-3xl w-fit max-w-full"
        >
      ...
      <div className="w-full flex my-2 justify-center items-center">
        <Button
          variant={"outline"}
          className="my-4 items-center bg-gradient-to-r from-cyan to-black-200 rounded-3xl w-fit max-w-full"
        >
          <div className=" flex items-center gap-2 justify-center text-white-400">
            <Terminal className="w-4 h-4" />
            <p className="text-lg">Its all about few commands.</p>
          </div>
        </Button>
      </div>
      <div className="w-full mt-4 ml-19 max-w-[95%]  rounded-xl p-4 mx-auto rounded-none relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-transparent to-cyan-500/10" />
        <div className="relative  flex flex-row   max-md:flex-col space-x-1">
          {/* <div className="flex ml-9 flex-col justify-center text-center">
            <h1 className="text-2xl font-font1 -tracking-wide  opacity-0 animate-slidein300 font-bold text-center text-white mb-2">
              Save.Share.Reuse
            </h1>
